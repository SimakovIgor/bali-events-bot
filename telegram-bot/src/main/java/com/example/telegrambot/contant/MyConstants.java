...
public class MyConstants {
    ...
    public static final String HELLO_I_AM_A_BOT_THAT_WILL_HELP_YOU_FIND_EVENTS_IN_BALI = "Привет! Я бот, который поможет тебе найти события на Бали. "
        + "Напиши дату в формате: 'dd.mm.yyyy' или выберите из календаря";
