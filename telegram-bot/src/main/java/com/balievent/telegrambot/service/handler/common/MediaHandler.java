...
public class MediaHandler {
    ...
    public List<SendMediaGroup> handleMultipleMedia(final Update update, final List<InputMediaPhoto> eventPhotos) {
    ...
    public SendPhoto handleSingleMedia(final Update update, final List<InputMediaPhoto> eventPhotos) {
    ...
    public List<InputMediaPhoto> findEventPhotosForUserDate(final Update update) {
        final LocalDate localDate = calendarDataStorage.get(update);
        return findEventPhotos(localDate);
    }
