...
@Slf4j
@Service
public abstract class AbstractPaginationHandlerButton extends ButtonCallbackHandler {
    @Autowired
    ...
    public void handle(final Update update) throws TelegramApiException {
        ...
        final String eventsBriefMessage = MessageBuilder.buildBriefEventsMessage(userData.getCurrentEventPage(), eventList);
